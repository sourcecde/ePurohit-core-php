									...
									<div class="row">
										<div class="span12">
											<div class="title-box clearfix ">
												<h2 class="title-box_primary">Purohit Booking</h2>
												<!-- <h3 class="title-box_secondary">second heding</h3> -->
											</div>
											<!-- //.title-box -->
										</div>
									</div>
											...
											<div class="span6">
												<div class="service-box services-home-three">
													<div class="service-box_body">
														...
														<h5 class="sub-title">Account transfer</h5>
															...
															<div id="newsletterwidget-2" class="visible-all-devices ">
																<div class="newsletter newsletter-widget">
																	<form action="" method="post">
																		<p>
																			<input class="newsletter-email" type="text" required name="ne" placeholder="transaction number" />
																		</p>
																		<p>
																			<input class="newsletter-submit" type="submit" value="Confirm"/>
																		</p>
																	</form>
																</div>
															</div>
