								...
								<div id="post-203" class="post-203 page type-page status-publish hentry page">
									<div class="row">
										<div class="span12">
											<div class="title-box clearfix ">
												<h2 class="title-box_primary">Welcome to our site!</h2>
												<h3 class="title-box_secondary">The Hindu Temple is a place of worship for devotees of the Hindu religion</h3>
											</div>
											<!-- //.title-box -->
										</div>
										<div class="span4">
									...
									<div class="darker-box pad">
										<div class="row">
											<div class="span7">
												<div class="hero-unit ">
													<h1>A Brief History of Our Temple</h1>
									...
									<div class="row">
										<div class="span12">
											<div class="title-box clearfix ">
												<h2 class="title-box_primary">Mission Statement</h2>
												<h3 class="title-box_secondary">While it's primary goal is to serve residents of the capital district, visitors from all over the world take part in its activities </h3>
											</div>
											<!-- //.title-box -->
											<ul class="posts-grid row-fluid unstyled mission">
												<li class="span3">
													<figure class="featured-thumbnail thumbnail">
														<a href="https://livedemo00.template-help.com/wordpress_48550/wp-content/uploads/2014/02/Depositphotos_36027193_original.jpg" title="Quisque nulla" rel="prettyPhoto-301106258">
														<img  src="https://livedemo00.template-help.com/wordpress_48550/wp-content/uploads/2014/02/Depositphotos_36027193_original-270x206.jpg" alt="Quisque nulla" />
														<span class="zoom-icon"></span>
														</a>
													</figure>
													<div class="clear"></div>
													<h5>
														<a href="https://livedemo00.template-help.com/wordpress_48550/pellentesque-sed-dolor/quisque-nulla/" title="Quisque nulla">Quisque nulla</a>
													</h5>
													<p class="excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed blandit massa vel mauris sollicitudin dignissim.... </p>
												</li>
												<li class="span3">
													<figure class="featured-thumbnail thumbnail">
														<a href="https://livedemo00.template-help.com/wordpress_48550/wp-content/uploads/2014/02/Depositphotos_37902661_original.jpg" title="Vestibulum libero" rel="prettyPhoto-301106258">
														<img  src="https://livedemo00.template-help.com/wordpress_48550/wp-content/uploads/2014/02/Depositphotos_37902661_original-270x206.jpg" alt="Vestibulum libero" />
														<span class="zoom-icon"></span>
														</a>
													</figure>
													<div class="clear"></div>
													<h5>
														<a href="https://livedemo00.template-help.com/wordpress_48550/aliquam-congue-fermentum-nisl/vestibulum-libero/" title="Vestibulum libero">Vestibulum libero</a>
													</h5>
													<p class="excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed blandit massa vel mauris sollicitudin dignissim.... </p>
												</li>
												<li class="span3">
													<figure class="featured-thumbnail thumbnail">
														<a href="https://livedemo00.template-help.com/wordpress_48550/wp-content/uploads/2014/02/Depositphotos_3658883_original.jpg" title="Selerisque eget" rel="prettyPhoto-301106258">
														<img  src="https://livedemo00.template-help.com/wordpress_48550/wp-content/uploads/2014/02/Depositphotos_3658883_original-270x206.jpg" alt="Selerisque eget" />
														<span class="zoom-icon"></span>
														</a>
													</figure>
													<div class="clear"></div>
													<h5>
														<a href="https://livedemo00.template-help.com/wordpress_48550/aliquam-congue-fermentum-nisl/selerisque-eget/" title="Selerisque eget">Selerisque eget</a>
													</h5>
													<p class="excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed blandit massa vel mauris sollicitudin dignissim.... </p>
												</li>
												<li class="span3">
													<figure class="featured-thumbnail thumbnail">
														<a href="https://livedemo00.template-help.com/wordpress_48550/wp-content/uploads/2014/02/Depositphotos_22298465_original.jpg" title="Malesuada at" rel="prettyPhoto-301106258">
														<img  src="https://livedemo00.template-help.com/wordpress_48550/wp-content/uploads/2014/02/Depositphotos_22298465_original-270x206.jpg" alt="Malesuada at" />
														<span class="zoom-icon"></span>
														</a>
													</figure>
													<div class="clear"></div>
													<h5>
														<a href="https://livedemo00.template-help.com/wordpress_48550/fusce-euismod-consequat-ante/malesuada-at/" title="Malesuada at">Malesuada at</a>
													</h5>
													<p class="excerpt">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed blandit massa vel mauris sollicitudin dignissim.... </p>
												</li>
											</ul>
										...
										<div class="row">
											<div class="span6">
												<figure class="alignleft aligntextleft ">
													<i class="icon-check-sign home-icons" style="color:#ffffff; font-size:33px; line-height:1.2em;">
													</i>
												</figure>
												<div class="hero-unit hero-on-blue margin">
													<h1>Epsum factorial non</h1>
													<p>Quisque nulla. Vestibulum libero nisl, portlerisque eget, malesuada at, neque. Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae. 
													</p>
												</div>
												<!-- .hero-unit (end) -->
												<figure class="alignleft aligntextleft "><i class="icon-leaf home-icons" style="color:#ffffff; font-size:33px; line-height:1.2em;"></i>
												</figure>
												<div class="hero-unit hero-on-blue">
													<h1>Deposit quid pro quo</h1>
													<p>Quisque nulla. Vestibulum libero nisl, portlerisque eget, malesuada at, neque. Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae. </p>
												</div>
												<!-- .hero-unit (end) -->
											</div>
											<div class="span6">
												<figure class="alignleft aligntextleft ">
													<i class="icon-globe home-icons" style="color:#ffffff; font-size:33px; line-height:1.2em;"></i>
												</figure>
												<div class="hero-unit hero-on-blue margin">
													<h1>Olypian quarrels et gorilla</h1>
													<p>Quisque nulla. Vestibulum libero nisl, portlerisque eget, malesuada at, neque. Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae. </p>
												</div>
												<!-- .hero-unit (end) -->
												<figure class="alignleft aligntextleft ">
													<i class="icon-gift home-icons" style="color:#ffffff; font-size:33px; line-height:1.2em;"></i>
												</figure>
												<div class="hero-unit hero-on-blue">
													<h1>Congolium sic ad nauseum</h1>
													<p>Quisque nulla. Vestibulum libero nisl, portlerisque eget, malesuada at, neque. Vivamus eget nibh. Etiam cursus leo vel metus. Nulla facilisi. Aenean nec eros. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae. </p>
												</div>
												<!-- .hero-unit (end) -->
											</div>
									...
									<div class="row">
										<div class="span12">
											<div class="title-box clearfix ">
												<h2 class="title-box_primary">The temple offers various religious services</h2>
												<h3 class="title-box_secondary">We are non-profit, tax exempt organization</h3>
											</div>
											<!-- //.title-box -->
										</div>
										<div class="span3">
											<div class="service-box services-home-two">
												...
												<div class="service-box_body">
													...
													<div class="service-box_txt">Sed ut perspiciatis unde s iste natus error sit voluptatem accusanloremque laudantium, totam re eaque ipsa tis et quasi architecto beatae vitae dicta. 
													</div>
												</div>
											</div>
											<!-- /Service Box -->
